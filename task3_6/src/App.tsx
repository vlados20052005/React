  ...
  return (
    <>
      <div className={styles.button}>
        ...
        <Button label="Button" variant="primary" withIcon />
        <Button label="Button" variant="secondary" />
        <Button label="Button" variant="secondary" withIcon />
      </div>
      <div className={styles.link}>
        <Link label="Link" href="#" />
        <Link label="Link" href="#" disabled />
      </div>
      ...
      {showToast && (
        <Toast message="Event deleted" onClose={handleCloseToast} duration={3000} />
      )}
    </div>
    </>
  );
